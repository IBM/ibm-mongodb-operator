...
func (r *MongoDBReconciler) createFromYaml(instance *mongodbv1.MongoDB, yamlContent []byte) error {
...
func (r *MongoDBReconciler) createUpdateFromYaml(instance *mongodbv1.MongoDB, yamlContent []byte) error {
	obj := &unstructured.Unstructured{}
	jsonSpec, err := yaml.YAMLToJSON(yamlContent)
	if err != nil {
		return fmt.Errorf("could not convert yaml to json: %v", err)
...
func (r *MongoDBReconciler) addControlleronPVC(instance *mongodbv1.MongoDB, sts *appsv1.StatefulSet) error {
