...
// MongoReconciler reconciles a MongoDB object
...
func (r *MongoReconciler) Reconcile(request ctrl.Request) (ctrl.Result, error) {
	...
	r.Log.Info("creating or updating mongodb statefulset")
...
func (r *MongoReconciler) createFromYaml(instance *mongodbv1alpha1.MongoDB, yamlContent []byte) error {
...
func (r *MongoReconciler) createUpdateFromYaml(instance *mongodbv1alpha1.MongoDB, yamlContent []byte) error {
	obj := &unstructured.Unstructured{}
	jsonSpec, err := yaml.YAMLToJSON(yamlContent)
	if err != nil {
		return fmt.Errorf("could not convert yaml to json: %v", err)
...
func (r *MongoReconciler) getstorageclass() (string, error) {
...
func (r *MongoReconciler) addControlleronPVC(instance *mongodbv1alpha1.MongoDB, sts *appsv1.StatefulSet) error {
